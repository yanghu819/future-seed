...
\item {\bf Open access to data and code}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: The submission package is intended to include an anonymized code snapshot, queue files, synced run artifacts for the final window, and exact paper build instructions; Appendix~D describes the layout.

\item {\bf Experimental setting/details}
    \item[] Question: Does the paper specify all the training and test details (e.g., data splits, hyperparameters, how they were chosen, type of optimizer, etc.) necessary to understand the results?
    \item[] Answer: \answerYes{}
    \item[] Justification: The core paper states the model and evaluation setup, while Appendix~A and D describe the screening policy, task families, artifact layout, and reproduction commands.
...
\item {\bf Experiments compute resources}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Sections~3 and 6 state that the campaign uses a single RTX 4090 and fixed quick-to-medium budgets; Appendix~A clarifies the serial screening policy and artifact scope.
