...
\begin{itemize}
  \item \textbf{Inference protocol}: compare one-shot argmax fill vs.\ iterative refinement (mask-predict) under equal compute.
  \item \textbf{Stronger baselines}: add structured decoders (e.g., assignment/matching) for permutation tasks to isolate modeling vs.\ decoding effects.
